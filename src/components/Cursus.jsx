  ...
  return (
    <div name='cursus' className='w-full text-white my-24'>
      ...
      <div className='max-w-[1240px] mx-auto py-2 '>
        ...
        <a href="# " className='transition-opacity flex flex-col items-center bg-white border rounded-lg shadow-md md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700'>
